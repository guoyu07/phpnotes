...
目前支持Composer的框架包括Symfony、Laravel、CodeIgniter、CakePHP、FuelPHP、Drupal和SilverStripe等。
...
在安装依赖后，Composer 将把安装时确切的版本号列表写入 composer.lock 文件。这将锁定改项目的特定版本，因此需要提交应用程序的 composer.lock （包括 composer.json）到版本库中
